    ...
    >
      <Defs>
        ...
        >
          ...
          <Stop offset={1} stopColor="#e39684" />
        </LinearGradient>
        <LinearGradient
          id="prefix__e"
          x1={0.742}
          ...
          gradientUnits="objectBoundingBox"
         >
            <Stop offset={1} stopColor="#E4A494" />
            <Stop offset={0} stopColor="#EACFC8" />
        </LinearGradient>
        <ClipPath id="prefix__b">
          <Path d="M0 0h375v812H0z" />
        </ClipPath>
      </Defs>
      <G data-name="Step 1 \u2013 5" clipPath="url(#prefix__b)">
        ...
        <G filter="url(#prefix__c)">
          <Path
            ...
            transform="rotate(180 291.385 863.545)"
            fill="url(#prefix__a)"
          />
        </G>
